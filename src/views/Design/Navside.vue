<template>
    <aside>
        ...
        <!-- 创建标签 -->
        <!-- <mu-dialog title="创建标签" width="600" max-width="80%" :esc-press-close="false" :overlay-close="false" :open.sync="openlabel">
            Let Google help apps determine location. This means sending anonymous location data to Google, even when no
            apps are running.
            <mu-button slot="actions" flat color="primary" @click="openlabel=false">取消</mu-button>
            <mu-button slot="actions" flat color="primary" @click="openlabel=false">Agree</mu-button>
        </mu-dialog> -->
