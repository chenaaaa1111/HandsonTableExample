    ...
    <main>
        <header class="headtoprow2">
            ...
            <div class="right">
                ...
                <mu-button flat color="primary" @click="isedit=true">
                    <mu-icon left value="history"></mu-icon>变更日志
                </mu-button>
                <mu-menu placement="bottom-end" :open.sync="editopen">
                    <mu-button flat color="primary">状态
                        <mu-icon right value="arrow_drop_down"></mu-icon>
                    </mu-button>
                    <mu-list slot="content">
                        <mu-list-item button v-for="(item,index) in editcolumntitle" :key="index" @click="edititem(index)">
                ...
                <mu-button icon color="primary" @click="togglelock">
                    <mu-icon v-show="lock" value="lock_open"></mu-icon>
                    <mu-icon v-show="!lock" value="lock_outline"></mu-icon>
                </mu-button>
            ...
            <div v-if="selectitem" class="headtoprow1">
                <div>
                    ...
                    <mu-text-field v-if="qty" icon=" " type="number" v-model="setqty" label="数量" :suffix="unit"
                        label-float :action-icon="'arrow_drop_down'" :action-click="selectunit"></mu-text-field>
                    <mu-text-field v-if="gb" icon=" " placeholder="请输入国标"></mu-text-field>
                    <mu-text-field v-if="material" icon=" " placeholder="请输入材料或品牌" :action-icon="'more_vert'"
                        :action-click="selectcate"></mu-text-field>
