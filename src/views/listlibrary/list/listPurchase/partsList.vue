            ...
            <mu-paper class="ribbonlayout" v-for="(item,index) in items" :key="index" :z-depth="1">
                ...
                <div class="ribbondesc">
                    ...
                    <div class="ribbondesc-2">
                        <!-- <mu-button icon color="primary" @click="$router.push('ProcessPart')">
                        ...
                        <mu-button icon color="primary" @click="$router.push('partstep')">
                    ...
                    <div class="ribbondesc-3">
                        ...
                        <mu-button flat @click="$router.push('partstep')">对比</mu-button>
                        <mu-button flat>审批</mu-button>
