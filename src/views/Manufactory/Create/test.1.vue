<template>
    <div class="mygrid">
        ...
        <div style="text-align:center;padding-left:40px;padding-right:40px;">
            ...
            <mu-text-field class="mygridcol-1" v-model="name" placeholder="序号" icon="star" style="min-width:10px;width:100px"></mu-text-field>
            <mu-text-field class="mygridcol-1" v-model="name" placeholder="编码" icon="star"></mu-text-field>
