...
import Full3 from '@/containers/Full3'
...
export const asyncRouterMap = [

 {
    ...
    hidden:false,
    children: [
     {path: '/dashboard',name: '最近',icon:'speedometer',component: _import('Dashboard')},
     {path: '/introduction',name: '收藏夹',icon:'android-favorite',component: _import('Introduction')},
     {path: '/table', name: '列表',icon:'android-list',component: _import('Table'),meta: { role: ['admin'] }},
     {path: '/jsontree', name: '分享',icon:'android-share-alt',component: _import('JsonTree')},
     {path: '/tabledetail/:id',name: '社区',icon:'android-people',component: _import('TableDetail')},
     {path: '/components',name: '标签',redirect: '/components/buttons',icon:'bookmark',
  ...
  },
  {
    ...
    hidden:false,
    children: [
     {path: '/home2/dashboard',name: 'Dashboard2',icon:'speedometer',component: _import('Dashboard2')},
     {path: '/home2/introduction',name: '介绍2',icon:'thumbsup',component: _import('Introduction')},
